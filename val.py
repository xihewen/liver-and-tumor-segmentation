...
from net.att_DialResUNet import DialResUNet

on_server = False

os.environ['CUDA_VISIBLE_DEVICES'] = '0'

val_ct_dir = 'D:/3d_unet/att_micc/data/liver/test/ct' if on_server is True else \
    '/home/hwxi/Data/liver/test/ct'

val_seg_dir = 'D:/3d_unet/att_micc/data/liver/test/seg' if on_server is True else \
    '/home/hwxi/Data/liver/test/seg'

liver_pred_dir = 'D:/3d_unet/att_micc/data/liver/test/pred_seg' if on_server is True else \
    '/home/hwxi/Data/liver/test/att_pred_seg'

module_dir = 'D:/3d_unet/att_micc/module/att/net12-20-200-2-0.032.pth' if on_server is True else '/home/hwxi/workplace_project/att_MICCAI/module/net-60-1-6-200-2-0.014.pth'
...
workbook = xw.Workbook('/home/hwxi/workplace_project/att_MICCAI/result/net-60-1-6-200-2-0.014.xlsx') 
