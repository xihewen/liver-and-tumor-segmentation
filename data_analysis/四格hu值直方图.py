...
for i in range(0, 131, 1):
    ...
    if i==0:
        seg = sitk.ReadImage(niiSegPath + str(i) + ".nii", sitk.sitkInt8)
        segimg = sitk.GetArrayFromImage(seg)
        src = sitk.ReadImage(niiImagePath + str(i) + ".nii",sitk.sitkInt16)
        srcimg = sitk.GetArrayFromImage(src)
        liver1,tumor1 = total_hu(srcimg, segimg)
        liver1 = np.array(liver1)
        tumor1 = np.array(tumor1)
        liver1[liver1>=200] = 200
        liver1[liver1 <= -200] = -200
        tumor1[tumor1 >= 200] = 200
        tumor1[tumor1 <= -200] = -200
        liver1.tolist()
        tumor1.tolist()
    if i==1:
        ...
        liver2 = np.array(liver2)
        tumor2 = np.array(tumor2)
        liver2[liver2 >= 200] = 200
        liver2[liver2 <= -200] = -200
        tumor2[tumor2 >= 200] = 200
        tumor2[tumor2 <= -200] = -200
        liver2.tolist()
        tumor2.tolist()
    if i == 4:
        ...
        liver3 = np.array(liver3)
        tumor3 = np.array(tumor3)
        liver3[liver3 >= 200] = 200
        liver3[liver3 <= -200] = -200
        tumor3[tumor3 >= 200] = 200
        tumor3[tumor3 <= -200] = -200
        liver3.tolist()
        tumor3.tolist()
    if i == 5:
        ...
        liver4 = np.array(liver4)
        tumor4 = np.array(tumor4)
        liver4[liver4 >= 200] = 200
        liver4[liver4 <= -200] = -200
        tumor4[tumor4 >= 200] = 200
        tumor4[tumor4 <= -200] = -200
        liver4.tolist()
        tumor4.tolist()
    if i>6:
...
plt.savefig("./hist_image/person.tif",dpi=600)
# plt.show()
plt.clf()
